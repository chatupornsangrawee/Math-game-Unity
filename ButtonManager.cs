...
public class ButtonManager : MonoBehaviour
{
    ...
    void OnButtonClick(Button clickedButton, Sprite spritePrefab)
    {
        ...
        GameObject ans2Object = GameObject.Find("Ans2");

        if (ans2Object != null)
        {
            // กำหนดตำแหน่งของวัตถุใหม่ให้เท่ากับตำแหน่งของ Ans2
            newObject.transform.position = ans2Object.transform.position;
            newObject.transform.localScale = new Vector3(0.5f, 0.5f);
        }
        else
        {
            Debug.LogError("GameObject with the name 'Ans2' not found in the scene!");
        }
    }
